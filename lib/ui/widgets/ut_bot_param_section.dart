...
///
/// Welle O3-B1 STUB — the real param inputs (key_value, atr_period, smi_*,
/// swing_lookback, tp_rr_ratio, risk_per_trade) ship in Welle O3-B1-3.
/// Renders a single info card today so the strategy dropdown can mount it
/// without crashing.
library;
    ...
    return Container(
      ...
      child: const Row(
        children: [
          ...
          Expanded(
            child: Text(
              'UT-Bot parameter inputs ship in Welle O3-B1-3. '
